#!/usr/bin/env bash
# Stage 1: visual perception RLVR for Qwen2.5-VL-7B.
# Usage:  source training/_env.sh && bash training/examples/qwen2_5_vl_7b/stage1_perception.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_stage1_perception \
