#!/usr/bin/env bash
# Stage 3: visual reasoning RLVR for Qwen2.5-VL-7B.
# Usage:  source training/_env.sh && bash training/examples/qwen2_5_vl_7b/stage3_visual_reasoning.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_stage3_visual_reasoning \
