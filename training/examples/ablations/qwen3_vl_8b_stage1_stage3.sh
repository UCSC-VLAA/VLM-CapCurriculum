#!/usr/bin/env bash
# Ablation: skip Stage 2 — train only Stage 1 → Stage 3 (Table 2 row "Stage 1→3").
# Set MODEL_PATH to the Stage-1 perception checkpoint.
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3_vl_8b_stage1_stage3 \
