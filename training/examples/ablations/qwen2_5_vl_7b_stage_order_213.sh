#!/usr/bin/env bash
# Stage-order 2→1→3 ablation on Qwen2.5-VL-7B (Table 5).
# Set MODEL_PATH to the post-Stage-1 checkpoint of the 2→1 chain.
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_stage_order_2_1_3 \
