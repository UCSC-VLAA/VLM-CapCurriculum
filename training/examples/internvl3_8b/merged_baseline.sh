#!/usr/bin/env bash
# Merged-training baseline for InternVL3-8B.
# Usage:  source training/_env.sh && bash training/examples/internvl3_8b/merged_baseline.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=internvl3_8b_merged_baseline \
