#!/usr/bin/env bash
# Stage 2: textual reasoning RLVR for InternVL3.5-8B.
# Usage:  source training/_env.sh && bash training/examples/internvl3_5_8b/stage2_text_reasoning.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=internvl3_5_8b_stage2_text_reasoning \
