#!/usr/bin/env bash
# Stage 1: visual perception RLVR for InternVL3.5-8B.
# Usage:  source training/_env.sh && bash training/examples/internvl3_5_8b/stage1_perception.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=internvl3_5_8b_stage1_perception \
