#!/usr/bin/env bash
# Stage 3: visual reasoning RLVR for InternVL3.5-8B.
# Usage:  source training/_env.sh && bash training/examples/internvl3_5_8b/stage3_visual_reasoning.sh
set -euo pipefail
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=internvl3_5_8b_stage3_visual_reasoning \
